...
//create spaces
const space1 = new Space('satu');
const space2 = new Space('dua');
const space3 = new Space('tiga');
const space4 = new Space('empat');
const space5 = new Space('lima');
const space6 = new Space('enam');
const space7 = new Space('tujuh');
const space8 = new Space('delapan');
const space9 = new Space('sembilan');
...
$('.grid').on('click', (e) => {
  if(player1.win !== true && player2.win !== true) {
    ...
    if(board[0][0] === "x" && board[0][1] === "x" && board[0][2] === "x") {
      $('.header').text('Player satu menang!');
